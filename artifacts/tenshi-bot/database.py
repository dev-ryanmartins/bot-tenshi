...
def _default_user() -> dict:
    return {
        ...
        "avatar_desc": None,
        "historia": None,
        "cabecalho_perfil": None,
        "subtitulo_perfil": None,
        "rodape_perfil": None,
        "habilidades": [],
        # Espécie e atributos
        "especie": None,
...
def _template_usuario() -> dict:
    ...
    return {
        ...
        "avatar_desc": None, "historia": None, "cabecalho_perfil": None,
        "subtitulo_perfil": None, "rodape_perfil": None, "habilidades": [],
        ...
        "casa_id": None, "casa_condominio": None, "moradia_custom": None, "fadiga": 0,
        "ultimo_descanso_lazer": None, "empresa_id": None, "empresa_custom": None, "cargo_empresa": None,
        "salario": 0, "familia_id": None, "organizacao_custom": None, "cargo_familia": None,
