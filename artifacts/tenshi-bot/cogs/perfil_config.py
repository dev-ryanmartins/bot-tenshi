...
async def _build_perfil_embed(bot, member: discord.Member | discord.User) -> discord.Embed:
    ...
    embed.add_field(name="🤝 Parentesco", value=user.get("parentesco") or "Membro", inline=True)
    embed.add_field(name="💠 Prestígio", value=user.get("prestigio") or "Bronze", inline=True)
